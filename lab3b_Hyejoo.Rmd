...
Learn the purpose of the dplyr and tidyr packages (part of the tidyverse package) and understand how to manipulate and analyze data with dplyr. To see the original tutorial [click here](https://datacarpentry.org/R-ecology-lesson/03-dplyr.html#Data_Manipulation_using_dplyr_and_tidyr).
