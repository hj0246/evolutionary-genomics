...
How to load you data file into a data frame? Understand what data frame is and how to inspect data using R. To see the original tutorial [click here](https://datacarpentry.org/R-ecology-lesson/02-starting-with-data.html).
